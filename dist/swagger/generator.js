...
var SpecGenerator = /** @class */ (function () {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            swaggerDirs.forEach(function (swaggerDir) {
                                mkdirp(swaggerDir).then(function () {
                                    ...
                                    fs.writeFile("".concat(swaggerDir, "/swagger.json"), JSON.stringify(spec, null, '\t'), function (err) {
                                        if (err) {
                                            return reject(err);
                                        }
                                        if (_this.config.yaml) {
                                            _this.debugger('Saving specs yaml file to folder: %j', swaggerDir);
                                            fs.writeFile("".concat(swaggerDir, "/swagger.yaml"), YAML.stringify(spec, 1000), function (errYaml) {
                                                if (errYaml) {
    ...
    SpecGenerator.prototype.getOperationId = function (controllerName, methodName) {
        ...
        return "".concat(controllerNameWithoutSuffix).concat(methodName.charAt(0).toUpperCase() + methodName.substr(1));
    };
    ...
    SpecGenerator.prototype.getSwaggerTypeForReferenceType = function (referenceType) {
        return { $ref: "#/definitions/".concat(referenceType.typeName) };
    };
