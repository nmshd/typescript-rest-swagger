...
export function isReferenceObject(schema: Schema): schema is OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.ReferenceObject {
    return schema && (schema as OpenAPIV3_1.ReferenceObject).$ref !== undefined;
}

export function isArrayObject(schema: Schema): schema is OpenAPIV3_1.ArraySchemaObject {
