...
export function isReferenceObject(schema: Schema): schema is OpenAPIV3.ReferenceObject {
    return schema && (schema as OpenAPIV3.ReferenceObject).$ref !== undefined;
}

export function isArrayObject(schema: Schema): schema is OpenAPIV3.ArraySchemaObject {
